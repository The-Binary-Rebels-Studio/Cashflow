...
class TransactionLoaded extends TransactionState {
  ...
  final List<TransactionWithCategory> incomeTransactions;
  final List<TransactionWithCategory> expenseTransactions;
  ...
  TransactionLoaded copyWith({
    ...
    List<TransactionWithCategory>? incomeTransactions,
    List<TransactionWithCategory>? expenseTransactions,
