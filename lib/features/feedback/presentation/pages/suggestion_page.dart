...
class _SuggestionPageState extends State<SuggestionPage> {
  ...
  Future<void> _submitSuggestion() async {
    ...
    try {
      ...
      final response = await feedbackService.submitSuggestion(suggestion);
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Your suggestion has been submitted successfully. Thank you for helping us improve CashFlow!',
        ),
        actions: [
          TextButton(
            onPressed: () {
